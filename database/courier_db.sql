...
CREATE TABLE IF NOT EXISTS `tbl_courier` (`cid` int(10) NOT NULL auto_increment,
                                                                                                                                                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                                                                                                                                                 `status` varchar(20) NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                                                                      `comments` varchar(250) NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                                                                                              `book_date` date NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                               PRIMARY KEY (`cid`)) ENGINE=MyISAM DEFAULT
...
INSERT INTO `tbl_courier` (`cid`, `cons_no`, `ship_name`, `phone`, `s_add`, `rev_name`, `r_phone`, `r_add`, `type`, `weight`, `invice_no`, `qty`, `book_mode`, `freight`, `mode`, `pick_date`, `pick_time`, `status`, `comments`, `book_date`)
...
CREATE TABLE IF NOT EXISTS `tbl_courier_officers` (`cid` int(10) NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `tbl_courier_track` (`id` int(10) NOT NULL auto_increment,
                                                                      `cid` int(10) NOT NULL,
                                                                                    `cons_no` varchar(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_offices` (`id` int(10) NOT NULL auto_increment,
